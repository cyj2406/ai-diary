...
사용자가 [일기 작성 영역]에 일기를 작성하고 [AI 분석 버튼]을 누르면 gemini-2.5-flash에 접속하여 텍스트 감성 분석을 실시한 후 [감성 이모지 영역]에 5개의 감성 중 하나를 더 강조하도록 하고 [AI 일기 감성 분석 결과] 영역에 gemini가 일기를 분석한 결과 텍스트를 나타내도록 한다.
...
---------------------------------------------------------------------------------------------------
* gemini api key 발급받기
발급받은 gemini api key를 .env.local 파일에 저장해줘.
---------------------------------------------------------------------------------------------------
프롬프트:
gemini-2.5-flash 모델을 연동해서 일기에 대한 감성 이모지와 텍스트 감성 분석을 기능을 만들어줘.
---------------------------------------------------------------------------------------------------
프롬프트:
